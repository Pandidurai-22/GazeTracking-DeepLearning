		...
		<form method="post" enctype="multipart/form-data" id="tutor-registration-form">
			...
			<div class="tutor-form-row">
				<div class="tutor-form-col-6">
					<div class ="tutor-form-group">
						<label>
							<?php esc_html_e('Mobile Number', 'tutor'); ?>
						</label>
						<input type ="text" name="mobile_number" value="<?php echo esc_attr( tutor_utils()->input_old( 'mobile_number' )); ?>" placeholder="<?php esc_html_e( 'Mobile Number', 'tutor'); ?>" required>
					</div>
				</div>
                <div v
			</div>
			...
			<div class="tutor-form-row">
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						<label>
							<?php esc_html_e( 'DCI No', 'tutor' ); ?>
						</label>
						<input type="text" name="dci_number" value="<?php echo esc_attr( tutor_utils()->input_old( 'dci_number' ) ); ?>" placeholder="<?php esc_html_e( 'Enter your DCI Number', 'tutor' ); ?>" required>
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						<label>
							<?php esc_html_e( 'Degree (BDS,MDS,etc..)', 'tutor' ); ?>
						</label>
						<input type="text" name="qualification" value="<?php echo esc_attr( tutor_utils()->input_old( 'qualification' ) ); ?>" placeholder="<?php esc_html_e( 'Your Highest Qualification', 'tutor' ); ?>" required>
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						<label>
							<?php esc_html_e( 'Speciality', 'tutor' ); ?>
						</label>
						<input type="text" name="Speciality" value="<?php echo esc_attr( tutor_utils()->input_old( 'Speciality' ) ); ?>" placeholder="<?php esc_html_e( 'Your Speciality', 'tutor' ); ?>" required>
					</div>
				</div>
			</div>
			...
			<div class="tutor-form-row">
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						<label>
							<?php esc_html_e( 'College', 'tutor' ); ?>
						</label>
						<input type="text" name="college" value="<?php echo esc_attr( tutor_utils()->input_old( 'college' ) ); ?>" placeholder="<?php esc_html_e( 'College Name', 'tutor' ); ?>" required>
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						<label>
							<?php esc_html_e( 'Year of Graduation', 'tutor' ); ?>
						</label>
						<input type="number" name="Year of Graduation" value="<?php echo esc_attr( tutor_utils()->input_old( 'Year of Graduation' ) ); ?>" placeholder="<?php esc_html_e( 'Year of Graduation', 'tutor' ); ?>" required min="1950" max="<?php echo date('Y'); ?>">
					</div>
				</div>
			</div>
			...
			<div class="tutor-form-row">
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						<label>
							<?php esc_html_e( 'Years of Experience', 'tutor' ); ?>
						</label>
						<input type="number" name="years_experience" value="<?php echo esc_attr( tutor_utils()->input_old( 'years_experience' ) ); ?>" placeholder="<?php esc_html_e( 'Years of Experience', 'tutor' ); ?>" required min="0">
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						<label>
							<?php esc_html_e( 'Practice Location', 'tutor' ); ?>
						</label>
						<input type="text" name="practice_location" value="<?php echo esc_attr( tutor_utils()->input_old( 'practice_location' ) ); ?>" placeholder="<?php esc_html_e( 'Current Practice Location', 'tutor' ); ?>" required>
					</div>
				</div>
			</div>
			...
			<div class="tutor-form-row">
				<div class="tutor-form-col-12">
					<div class="tutor-form-group">
						<label>
							<?php esc_html_e( 'Full Address', 'tutor' ); ?>
						</label>
						<textarea name="full_address" placeholder="<?php esc_html_e( 'Enter your complete address', 'tutor' ); ?>" required rows="3"><?php echo esc_textarea( tutor_utils()->input_old( 'full_address' ) ); ?></textarea>
					</div>
				</div>
			</div>
			...
			<div>
				<button type="submit" name="tutor_register_student_btn" value="register" class="tutor-btn tutor-btn-primary tutor-btn-block"><?php esc_html_e( 'Register and pay', 'tutor' ); ?></button>
			</div>
